...
@section('content')
    <header>
        <h1>Silahkan Isi Formulir Absensi Kegiatan</h1>
    </header>
    <hr class="header-line">
    <div class="isi-form" id="isi-form">
        <form id="attendanceForm" action="{{ route('absen.store') }}" method="POST" class="form-container" enctype="multipart/form-data">
            @csrf
